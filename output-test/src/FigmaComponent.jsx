...
const FigmaComponent = () => {
  ...
  return (
    <body className="figma-container">
      ...
      </div></div><button className="button_13" type="button"><p className="p_14">Sign In</p></button></div></div></div></div>
    </body>
  );
};
